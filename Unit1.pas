...
function EjecutarQueryYRetornarJSON(query : TMSQuery): string;
function EnviarDataWebService(json : string): boolean;

const
  //WebServiceUrl : string = 'https://jsonplaceholder.typicode.com/posts';
  WebServiceUrl : string = 'https://us-central1-sils-stage.cloudfunctions.net/handlerViajesYpfGas';  
...
begin
  try
    ...
    json := EjecutarQueryYRetornarJSON(query);  
